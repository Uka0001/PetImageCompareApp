...
import java.util.Random;
 //The following code example divides an image into four quadrants and randomly draws
 // each quadrant of the source image into a different quadrant of the destination.
...
public class JumbledImageApplet extends JApplet {
    ...
    static String imageFileName = "src/resources/actual.png";
